...
test("DirectEnvelopeV4 has one exact required field set and canonical transcripts", async () => {
  ...
  for (const [key, replacement] of [
    ...
    ["senderBindingDigest", repeatedBase64(21, 32)],
    ["recipientBindingDigest", repeatedBase64(22, 32)],
...
function directFixture({ signature = repeatedBase64(7, 3_309) } = {}) {
  return {
    ...
    senderBindingDigest: repeatedBase64(4, 32),
    recipientEndpointHandle: { rawValue: repeatedBase64(5, 32) },
    recipientBindingDigest: repeatedBase64(6, 32),
...
function groupFixture() {
  return {
    ...
    senderCredentialHandle: { rawValue: repeatedBase64(13, 32) },
